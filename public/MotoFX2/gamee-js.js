/*! @preserve build time 2024-05-11 15:37:59 */
...
var core = exports.core = function () {
    ...
    //     this.native.gameLoadingProgress(100); // FB requires this
    //     this.native.gameStart(gamee);
    // };
...
Gamee.prototype = function () {
    ...
    return {
        ...
        gameStart: function gameStart(opt_cb) {
            // opt_cb = opt_cb || cbError;
            // validateDataType(opt_cb, "function", "opt_cb", "gamee.gameStart");
            // core.gameStart();
            // opt_cb(null);
        },
